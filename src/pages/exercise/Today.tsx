...
const Today = (props) => {
    ...
    const handleEtypeChange = (value) => {
        ...
        for (const part of dayList[value]['Monday']){
            console.log(part, Object.keys(exercises))
        ...
        function makeTableSnap(docs) {
            ...
            getDocumentsAsync(user, 'data', `exercises/${value}/${exercise}`, [makeTableSnap],false, 1, ['Date', 'desc'], nosnap)
            console.log('TableData', tableData)
        }
        }

        }
        getDocumentAsync(user, 'settings', 'exercises/' + value, [main])
